...
namespace ISPCore.Application.Transaction.Command
{
    public static class Commands
    {
        ...
        {
            public class Create : IRequest<TransactionCommandVM>
            {
            ...
            public class Update : IRequest<TransactionCommandVM>
            {
            ...
            public class MarkAsDelete : IRequest<TransactionCommandVM>
            {
                public int Id { get; set; }
            }
        }
