...
namespace ISPCore.Application.ClientDetails.Command
{
    public static class Commands
    {
        ...
        {
            public class Create : IRequest<ClientDetailsCommandVM>
            {
            ...
            public class Update : IRequest<ClientDetailsCommandVM>
            {
            ...
            public class MarkAsDelete : IRequest<ClientDetailsCommandVM>
            {
                public int Id { get; set; }
            }
        }
